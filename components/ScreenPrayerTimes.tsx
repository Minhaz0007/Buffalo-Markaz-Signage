  ...
  return (
    <div className="w-full h-full flex flex-col font-serif text-white overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden h-full">
          ...
          {/* === LEFT COLUMN: PRAYER TABLE (64%) === */}
          <div className="w-[64%] flex flex-col border-r-4 border-black/30 relative z-10 shadow-xl h-full">
            {/* Header Row */}
          ...
          {/* === RIGHT COLUMN: SLIDESHOW CONTAINER (36%) === */}
          <div className="w-[36%] bg-[#E5E5E5] text-mosque-navy flex flex-col z-10 shadow-2xl h-full relative overflow-hidden">
