...
const ClockSlide = React.memo(({ hours, minutes, seconds, displayAmPm, nextPrayerName, timeUntilIqamah, hijriDate, formatDate, currentTime, prayers }: any) => {
    return (
        <div className="w-full h-full flex flex-col relative z-10 p-6 animate-in fade-in duration-700">
            ...
            <div className="flex-[1] flex flex-col items-center justify-center border-b border-mosque-navy/10 py-1 space-y-2 shrink-0 bg-mosque-gold rounded-lg my-2">
            ...
            <div className="flex-[3] shrink-0 flex flex-col justify-center relative">
                <div className="flex items-center justify-around h-full">
                    ...
                    <span className="text-5xl uppercase tracking-[0.3em] font-bold text-mosque-navy/50 mb-2">Sunrise</span>
                    <TimeDisplay
                        time={prayers.sunrise}
                        className="text-[7.5rem] font-serif font-bold leading-none tracking-tight"
                    ...
                    <span className="text-5xl uppercase tracking-[0.3em] font-bold text-mosque-navy/50 mb-2">Sunset</span>
                    <TimeDisplay
                        time={prayers.sunset}
                        className="text-[7.5rem] font-serif font-bold leading-none tracking-tight"
                        colorClassName="text-mosque-navy"
