        ...
        <div className="w-full h-full flex flex-col relative z-10 p-6 animate-in fade-in duration-700">
            ...
            <div className="flex-[3] shrink-0 flex flex-col justify-center relative">
                <div className="flex items-center justify-around h-full">
                    ...
                    <TimeDisplay time={prayers.sunrise} className="text-[6.5rem] font-bold leading-[0.85]" colorClassName="text-mosque-navy" />
                    </div>
                    ...
                    <TimeDisplay time={prayers.sunset} className="text-[6.5rem] font-bold leading-[0.85]" colorClassName="text-mosque-navy" />
                    </div>
